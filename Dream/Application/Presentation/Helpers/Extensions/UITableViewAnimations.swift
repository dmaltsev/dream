...
public enum TableViewAnimation {
    ...
    public enum Table {
        ...
        case top(duration: Foundation.TimeInterval)
        case left(duration: Foundation.TimeInterval)
        case right(duration: Foundation.TimeInterval)
        case bottom(duration: Foundation.TimeInterval)
        case fade(duration: Foundation.TimeInterval)
        case custom(duration: Foundation.TimeInterval, transform: CGAffineTransform, options: UIView.AnimationOptions)
        ...
        fileprivate enum AnimationDirection {
            ...
            func xPosition(tableView: UITableView) -> CGFloat {
                switch self {
...
public extension UITableView {
    ...
    func animate(animation: TableViewAnimation.Table, completion: (() -> Void)? = nil) {
        ...
        case .left(let duration):
            self.animateTableViewWithDirection(duration: duration, direction: .left, completion: completion)
            
        case .right(let duration):
            self.animateTableViewWithDirection(duration: duration, direction: .right, completion: completion)
...
fileprivate extension UITableView {
    ...
    func animateTableViewWithTransform(duration: Foundation.TimeInterval, transform: CGAffineTransform, options: UIView.AnimationOptions = .curveEaseInOut, completion: (() -> Void)? = nil) {
    ...
    func animateTableViewWithDirection(duration: Foundation.TimeInterval, direction: TableViewAnimation.Table.AnimationDirection, completion: (() -> Void)? = nil) {
        let damping: CGFloat = 0.75
        
        let cellTransform = CGAffineTransform(translationX: direction.xPosition(tableView: self), y: direction.yPosition(tableView: self))
...
fileprivate extension UITableView {
    ...
    func animateTableCellsWithDirection(duration: Foundation.TimeInterval, direction: TableViewAnimation.Cell.AnimationDirection, indexPaths:[IndexPath]?, completion: (() -> Void)? = nil) {
        ...
        for (index, cell) in visibleCells.enumerated() {
            let delay: Foundation.TimeInterval = duration/Double(self.visibleCells.count)*Double(index)
    ...
    func animateTableCellsWithTransform(duration: Foundation.TimeInterval, transform: CGAffineTransform, options: UIView.AnimationOptions = .curveEaseInOut, completion: (() -> Void)? = nil) {
...
fileprivate extension UITableView {
    ...
    func animateWithFade(duration: Foundation.TimeInterval, consecutively: Bool, completion: (() -> Void)? = nil) {
        if consecutively {
            for (index, cell) in self.visibleCells.enumerated() {
                let animationDelay: Foundation.TimeInterval = duration/Double(visibleCells.count)*Double(index)
